            ...
            }
            {
                ...
                <>
                    <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center', gap: 32 }}>
                        <Image style={{ width: 70, height: 70, tintColor: 'white' }} contentFit='contain' source={images.logo_icon} />
                        <Text style={{ fontSize: 24, fontWeight: 'bold', color: 'white' }}>Thanks for joining Kuky! </Text>
                        <Text style={{ lineHeight: 24, fontSize: 16, fontWeight: 'bold', color: 'white', textAlign: 'center' }}>Your account is under review and will be approved soon. </Text>
                        <Text style={{ lineHeight: 24, fontSize: 16, fontWeight: 'bold', color: 'white', textAlign: 'center' }}>In the meantime, feel free to explore and discover other users!</Text>
                    </View>
                    ...
                    <TouchableOpacity onPress={onOpenProfile} style={{ marginBottom: insets.bottom + 16, width: '100%', height: 40, borderRadius: 30, alignItems: 'center', justifyContent: 'center' }}>
