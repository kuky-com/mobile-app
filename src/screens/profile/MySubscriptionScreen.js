...
const MySubscriptionScreen = ({ navigation }) => {
  ...
  const updateProfile = async () => {
    try {
      Keyboard.dismiss();
      setLoading(true);
      // TODO: full name was never defined. I don't get what happened here
      const fullName = "THIS NEVER WORKED IN CODE";
      apiClient
  ...
  return (
    <View style={styles.container}>
      ...
      >
        ...
        <Text
          style={{ flex: 1, textAlign: "center", fontSize: 20, color: "white", fontWeight: "bold" }}
        >
          My Subscription
        </Text>
        ...
        >
          <View style={{ gap: 8 }}>
            ...
            <View style={styles.inputContainer}>
              <Text style={{ flex: 1, fontSize: 16, color: "#333333", fontWeight: "bold" }}>
                {activeSubscription ? `Preminum - ${activeSubscription.title}` : "Free User"}
              </Text>
              <TouchableOpacity
              ...
              >
                <Image
                  ...
                  style={{ tintColor: "#333333", width: 13, height: 13 }}
                  contentFit="contain"
                />
              </TouchableOpacity>
            </View>
          ...
          <View style={{ gap: 8 }}>
            ...
            <View style={styles.inputContainer}>
              <Text style={{ flex: 1, fontSize: 16, color: "#333333", fontWeight: "bold" }}>
                {activeSubscription
                  ? `${activeSubscription.priceString} / ${activeSubscription.title}`
                  : ""}
              </Text>
            </View>
          </View>
