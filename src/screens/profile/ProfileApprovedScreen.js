    ...
    return (
        <View style={styles.container}>
            ...
            <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center', gap: 32 }}>
                ...
                <Text style={{ lineHeight: 24, fontSize: 16, fontWeight: 'bold', color: 'white', textAlign: 'center' }}>Your account has been approved, and you’re all set to start connecting on Kuky. </Text>
                <Text style={{ lineHeight: 24, fontSize: 16, fontWeight: 'bold', color: 'white', textAlign: 'center' }}>Dive in and explore shared interests with other users!</Text>
            </View>
