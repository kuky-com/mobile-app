    ...
    return (
        <View style={styles.container}>
            ...
            <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center', gap: 32 }}>
                ...
                <Text style={{ lineHeight: 24, fontSize: 16, fontWeight: 'bold', color: 'white', textAlign: 'center' }}>{message}</Text>
                <Text style={{ lineHeight: 24, fontSize: 16, fontWeight: 'bold', color: 'white', textAlign: 'center' }}>We encourage you to review this and reapply if you’d like. Thank you for your understanding!</Text>
            </View>
