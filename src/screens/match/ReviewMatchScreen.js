        ...
        <View style={{ flex: 1, width: "100%", gap: 16, alignItems: "center" }}>
          ...
          >
            <TouchableOpacity onPress={() => setRating(1)}>
              <Image
                source={rating > 0 ? images.star_fill : images.star_empty}
            ...
            <TouchableOpacity onPress={() => setRating(2)}>
              <Image
                source={rating > 1 ? images.star_fill : images.star_empty}
                style={{ width: 45, height: 45 }}
                contentFit="contain"
              />
            </TouchableOpacity>
            <TouchableOpacity onPress={() => setRating(3)}>
              <Image
                source={rating > 2 ? images.star_fill : images.star_empty}
                style={{ width: 45, height: 45 }}
                contentFit="contain"
              />
            </TouchableOpacity>
            <TouchableOpacity onPress={() => setRating(4)}>
              <Image
                source={rating > 3 ? images.star_fill : images.star_empty}
                style={{ width: 45, height: 45 }}
                contentFit="contain"
              />
            </TouchableOpacity>
            <TouchableOpacity onPress={() => setRating(5)}>
              <Image
                source={rating > 4 ? images.star_fill : images.star_empty}
                style={{ width: 45, height: 45 }}
                contentFit="contain"
              />
            </TouchableOpacity>
          ...
          <View style={{ flexDirection: "row", alignItems: "center", gap: 16 }}>
            <TouchableOpacity
              ...
              style={{
                ...
                justifyContent: "center",
                backgroundColor:
                  reason.indexOf("Supportive") >= 0
                    ? "rgba(181, 171, 226, 0.5)"
                    : "rgba(181, 171, 226, 0.1)",
              }}
            >
              <Text
                style={{ fontSize: 16, fontWeight: "bold", color: "#333333", textAlign: "center" }}
              >
                Supportive
              </Text>
            </TouchableOpacity>
            <TouchableOpacity
              onPress={() => addReason("Empathic")}
              style={{
                borderColor: "#D6D4E4",
                borderWidth: 1,
                borderRadius: 10,
