...
const toastConfig = {
  ...
  review_sent: ({ text1, props, text2 }) => (
    <View style={{ flex: 1, padding: 16, margin: 0, gap: 32, backgroundColor: '#000000aa', width: Dimensions.get('window').width, height: Dimensions.get('window').height, alignItems: 'center', justifyContent: 'center' }}>
      <StatusBar backgroundColor='#725ED4' />
      <View style={{ backgroundColor: '#725ED4', width: '100%', gap: 20, paddingHorizontal: 16, paddingVertical: 48, borderRadius: 16 }}>
        <Text style={{ fontSize: 20, color: 'white', fontWeight: 'bold', textAlign: 'center' }}>Thank you for your feedback!</Text>
        <Text style={{ fontSize: 16, lineHeight: 18, color: 'white', fontWeight: 'bold', textAlign: 'center' }}>{`Your review has been submitted.\nYour input helps us build a supportive and positive community.`}</Text>
      </View>
    </View>
  ),
}
